...
chcp 65001 >nul
REM ============================================================
REM  FinPath - Haiku 4.5 tom tat tin (thay Claude API).
...
REM 2) Haiku 4.5 tom tat + ghi ai_digest.json (qua goi Claude Code, khong ton API)
type updater\ai_prompt.txt | "C:\Users\chuta\AppData\Roaming\npm\claude.cmd" -p --model claude-haiku-4-5-20251001 --permission-mode acceptEdits
...
git commit -m "Tin AI: Haiku 4.5 tu dong"
git fetch origin
